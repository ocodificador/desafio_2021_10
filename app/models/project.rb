class Project < ApplicationRecord
  ...
  # Projetos com atividades de data final superior a data final do projeto
  # serão considerados com atrasados
  def delayed
    activities.where("end_date > ?", end_date).count > 0
  end

  # Retorna o % completo do projeto considerandos as atividades concluídas
  def complete
  ...
  # Se todas 100% das atividades foram concluídas o projeto está finalizado
  def finished
    complete == 100
  end
